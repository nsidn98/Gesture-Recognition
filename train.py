...
'''
This module trains the given dataset.
...
if __name__ == '__main__':
	...
	root="data12345" #Default directory containing the dataset
...
#	grid_search.fit(X_train,Y_train)
	...
	joblib.dump(clf, 'model_123456.pkl')
	#Saves the classes to the "classes.pkl" file
	joblib.dump(classes, 'classes_123456.pkl')
